...
- `username` (string) Username to use when registering the proxy tunnel (HTTP Basic Auth)
- `password` (string) Password to use when registering the proxy tunnel (HTTP Basic Auth)
